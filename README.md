...
require(value > 3);
```
1.  函数尽可能使用external替代public
无
1.  函数尽可能使用internal替代public
无
1.  启用 Solidity Gas 优化器
无
1.  缩短昂贵的操作
